...
void Stepper_Motor_Init()
{
	...
	// Configure the PB0 , PBl, PB2, and PB3 pins as output
	// by setting Bits 3 to 0 in the DIR register
	GPIOB->DIR |= 0x0F;
	
	// Configure the PB0 , PBl, PB2, and PB3 pins to function as
	// GPIO pins by clearing Bits 3 to 0 in the AFSE.L register
	GPIOB->AFSEL &= ~0x0F;
	
	// Enable the digital functionality for the PB0 , PBl, PB2, a.nd PB3 pins
	// by setting Bits 3 t o 0 in the DEN register
	GPIOB->DEN |= 0x0F;
